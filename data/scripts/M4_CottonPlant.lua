...
function JobComplete_M4_SuperTendCottonPlant()
	Object.CancelJob(myPlant,"M4_TendCottonPlant")
...
function JobComplete_M4_PlantCottonSeed()
...
function JobComplete_M4_TendCottonPlant()
	Object.CancelJob(myPlant,"M4_SuperTendCottonPlant")
	Set(this,"SuperCompostOrdered",nil)
	Set(this,"CompostOrdered",nil)
    Set(this,"NeedsTending","No")
	if this.NeedsDDT == "No" and this.IsRipe == "No" and this.IsDead == "No" then
...
function JobComplete_M4_PruneCottonPlant()
	Set(this,"AgeHours", 0.0)
	Set(this,"AgeMinutes", 0.0)
	if math.random() > .5 then
		Set(this,"SubType", 1)
	...
	local name = Object.Spawn( "M4_CottonPrunedPlant", this.Pos.x, this.Pos.y )
...
function JobComplete_M4_DDTCottonPlant()
	Set(this,"DDTOrdered",nil)
    Set(this,"NeedsDDT","No")
	SetPlantTooltip()
end

function JobComplete_M4_RemoveStruckCottonPlant()
	Object.CancelJob(this,"M4_RemoveDeadCottonPlant")
	local name = Object.Spawn( "M4_CottonPlantStruck", this.Pos.x, this.Pos.y )
	local velX = -1.0 + math.random() + math.random()
	local velY = -1.0 + math.random() + math.random()
	Object.ApplyVelocity(name, velX, velY)
...
function JobComplete_M4_RemoveDeadCottonPlant()
	Object.CancelJob(this,"M4_RemoveStruckGardenPlant")
	local name = Object.Spawn( "M4_CottonDeadPlant", this.Pos.x, this.Pos.y )
	local velX = -1.0 + math.random() + math.random()
	local velY = -1.0 + math.random() + math.random()
	Object.ApplyVelocity(name, velX, velY)
	Set(this,"IsEmpty",nil)
...
function JobComplete_M4_HarvestCottonPlant()
	Set(this,"AgeHours", 0.0)
	Set(this,"AgeMinutes", 0.0)
	Set(this,"IsRipe","No")
	
	if RawCottonNr == nil then FindStackNumbers() end
	
	local name = Object.Spawn("Stack", this.Pos.x, this.Pos.y )
	Set(name,"Contents",RawCottonNr)
...
function SetPlantTooltip()
	if this.IsDead == "Yes" then
		this.Tooltip = { "tooltip_M4_PlantDead",this.ControlUID,"X" }
	elseif this.IsEmpty == nil or this.IsEmpty == "Yes" then
		this.Tooltip = { "tooltip_M4_PlantSeed",this.ControlUID,"X" }
	else
		if this.FastGrowing == true then
			this.Tooltip = { "tooltip_M4_PlantStatus",this.ControlUID,"X","tooltip_M4_button_"..this.PlantType,"A","tooltip_M4_FastGrowYes","L",this.AgeHours,"B",this.AgeMinutes,"C",HourToHarvest[this.HarvestHour],"D","tooltip_M4_button_Needs"..this.NeedsTending,"E","tooltip_M4_button_Needs"..this.NeedsWater,"F","tooltip_M4_button_Needs"..this.NeedsDDT,"G","tooltip_M4_button_Needs"..this.NeedsFerti,"H","tooltip_M4_button_Needs"..this.NeedsPruning,"I","tooltip_M4_button_Needs"..this.IsRipe,"J", this.RemainHarvest,"K"}
		else
			this.Tooltip = { "tooltip_M4_PlantStatus",this.ControlUID,"X","tooltip_M4_button_"..this.PlantType,"A","tooltip_M4_FastGrowNo","L",this.AgeHours,"B",this.AgeMinutes,"C",HourToHarvest[this.HarvestHour],"D","tooltip_M4_button_Needs"..this.NeedsTending,"E","tooltip_M4_button_Needs"..this.NeedsWater,"F","tooltip_M4_button_Needs"..this.NeedsDDT,"G","tooltip_M4_button_Needs"..this.NeedsFerti,"H","tooltip_M4_button_Needs"..this.NeedsPruning,"I","tooltip_M4_button_Needs"..this.IsRipe,"J", this.RemainHarvest,"K"}
		end
	end
end
...
function FindStackNumbers()
	...
	for i = 1,2000 do
		...
		if newStack.Contents == "M4_RawCotton" then
			RawCottonNr = i
